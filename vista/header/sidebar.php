            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <?php } ?>
                        <a <?php if ($_GET['c'] == 'profile') { ?> class="nav-link text-light" <?php } else { ?> class="nav-link" <?php } ?> href="index.php?c=profile&a=index">
                            <div <?php if ($_GET['c'] == 'profile') { ?> class="sb-nav-link-icon text-light" <?php } else { ?> class="sb-nav-link-icon" <?php } ?>><i class="fas fa-user"></i></div>
                            Mi perfil
                        </a>
                    </div>
                </div>
