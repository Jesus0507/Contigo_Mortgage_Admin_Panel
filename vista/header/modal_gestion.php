    ...
    <div class="custom-modal-options mt-2 mb-2">
        <div class="d-flex flex-row justify-content-between w-100">
            ...
            <div style="font-weight: bold" class="d-flex flex-row <?php if ($_SESSION['user_role'] != 'admin') { ?> d-none <?php } ?>">
                <div id="asesor_asignado_label_gestion">Asesor:</div>
                <div><input class="form-control" style="width: 80%; margin-left: 10px; height: 25px;" id="asesor_name" list="users_datalist" placeholder="Asignar a ..." <?php if ($_SESSION['user_role'] != "admin") { ?> value="<?php echo $_SESSION['username'] ?>" <?php } ?>>
