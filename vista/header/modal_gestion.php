<div class="custom-modal modal-gestion">
    ...
    <div class="custom-modal-options mt-2 mb-2">
        <div class="d-flex flex-row justify-content-between w-100">
            ...
            <div style="font-weight: bold" class="d-flex flex-row">
                <div class="<?php if ($_SESSION['user_role'] != 'admin') { ?> d-none <?php } ?>" id="asesor_asignado_label_gestion">Asesor:</div>
                <div class="<?php if ($_SESSION['user_role'] != 'admin') { ?> d-none <?php } ?>"><input class="form-control" style="width: 80%; margin-left: 10px; height: 25px;" id="asesor_name" list="users_datalist" placeholder="Asignar a ..." <?php if ($_SESSION['user_role'] != "admin") { ?> value="<?php echo $_SESSION['email'] ?>" <?php } ?>>
                ...
                <div>Prioridad:</div>
                <div><select id="prioridad" class="form-select notranslate" style="height:27px; padding-top: 0 !important; color: #F5B027; font-weight: bold" <?php if ($_SESSION['user_role'] == 'consultor') { ?> disabled <?php } ?>>
    ...
    <div class="custom-modal-body">
        <div class="w-100" id="gestion_container" style="height: 100%;">
